    ...
    <div className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">About কৃষক লাগবে</h1>
          <p className="text-lg text-gray-600 mt-4">Connecting communities, empowering farmers.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-4">আমাদের লক্ষ্য</h2>
        ...
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-semibold text-center text-gray-800 mb-8">What We Offer</h2>
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-semibold text-center text-gray-800 mb-8">Meet the Team</h2>
